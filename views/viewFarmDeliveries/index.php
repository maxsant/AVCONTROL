...
<head>
    <title>Descargue Inventario</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Vista Descargue Inventario</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Vista</a></li>
                                        <li class="breadcrumb-item active">Descargue Inventario</li>
                                    </ol>
                                </div>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="row g-3">
                                                <div class="col-lg-3 col-6">
                                                    ...
                                                    <h5 class="fs-14 mb-0">C-<span id="farm_delivery_id"></span></h5>
                                                </div>

                                                <div class="col-lg-3 col-6">
                                                    <p class="text-muted mb-2 text-uppercase fw-semibold">Fecha</p>
                                                    <h5 class="fs-14 mb-0"><span id="farm_delivery_created"></span></h5>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card-body p-4 border-top border-top-dashed">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-6">
                                                    <h6 class="text-muted text-uppercase fw-semibold mb-3">Datos de la Granja</h6>
                                                    <p class="fw-medium mb-2" id="farm_name"></p>
                                                    <p class="fw-medium mb-2" id="farm_location"></p>
                                                </div>
                                            ...
                                            <div class="border-top border-top-dashed mt-2">
                                                ...
                                                <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                    <tbody>
                                                        <tr>
                                                            <td>Sub Total</td>
                                                            <td class="text-end" id="farm_delivery_subtotal"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>IVA (19%)</td>
                                                            <td class="text-end" id="farm_delivery_iva"></td>
                                                        </tr>
                                                        <tr class="border-top border-top-dashed fs-15">
                                                            <th scope="row">Total</th>
                                                            <th class="text-end" id="farm_delivery_total"></th>
                                                        </tr>
                                                    </tbody>
                                                </table>
    ...
    <script type="text/javascript" src="viewFarmDelivery.js"></script>
</body>
