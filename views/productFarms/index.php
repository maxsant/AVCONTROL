...
$data = $role->getAccessByRol($_SESSION['role_id'], 'productFarms');
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Producto Granjas</h4>
                                
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Mantenimiento</a></li>
                                        <li class="breadcrumb-item active">Producto Granja</li>
                                    </ol>
                                </div>
    ...
    <script type="text/javascript" src="productFarm.js"></script>
</body>
</html>
<?php
    }else{
